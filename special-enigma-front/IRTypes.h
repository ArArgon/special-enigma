...
namespace IntermediateRepresentation {
    ...
    enum IRStmtType {
        ...
        ADD,        // addition
        /**
         * add i32  %dest, i32 %opr1, i32 %opr2 -- var first, immNum second
         * %dest = %opr1 + %opr2;
         * */
    ...
    public:
        ...
        //this is added for opt;
        //scope stand for it's location (-1 for global, 0, 1, 2...n for function NO.n)
        std::vector<int> use_scope;
        ...
        void setIrOpType(IROpType irType) {
            IROperand::irOpType = irType;
        }
    ...
    public:
        ...
        std::vector<Statement> &getGlobal() {
            return global;
        }
